...
const ReadingCard = (props)=>{
    return(
        <div className="flex items-center sm:w-[800px] justify-center sm:gap-5 border px-6 py-5 rounded-2xl">
            <div >
            ...
            <div className="sm:w-[450px]">
                ...
                <button className="flex items-center text-[16px] border border-black px-6 py-2">Explore <BsArrowRight/> </button>
            </div>
        </div>
    )
}
